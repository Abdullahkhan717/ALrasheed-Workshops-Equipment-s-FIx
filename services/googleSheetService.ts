...
const SCRIPT_URL = (import.meta.env.VITE_SHEETDB_URL || 'https://script.google.com/macros/s/AKfycby_IgbwNR2EWn7vwy7XlxNKbgqPmqI6ZE7eZ3_Wkktyfx0TTfP_l00yb6ThGE8d9STJfw/exec').trim();
